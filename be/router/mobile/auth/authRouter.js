...
import { loginBase, 
    ...
    logout,
    countUser,
    resendRegisterOtp } from "../../../controller/mobile/oauth/authBase.js";
import {
    getListLogin
 ...
 */
routerauth.post("/sign-in", loginBase);
routerauth.get("/profile", Limiter50 , authMiddleware, logMiddleware, getProfile);
/**
 * @swagger
 * /profile:
 *   get:
 ...
 *                   example: Terlalu banyak request, coba lagi nanti
 */
routerauth.delete("/sign-out",Limiter5, authMiddleware, logout);
/**
 * @swagger
 * /sign-out:
 *   delete:
 ...
 *                   example: null
 */
routerauth.patch("/change-password", Limiter20, authMiddleware, changePassword); //sudah login
/**
 * @swagger
 * /change-password:
 *   patch:
 ...
 *                   example: null
 */
routerauth.patch("/edit-profile", Limiter15, authMiddleware, kelolaProfile); //edit profile
/**
 * @swagger
 * /edit-profile:
 *   patch:
 ...
 */
routerauth.post("/recovery-password-sudah-login", Limiter20, authMiddleware, recoveryPasswordsudahlogin);
/**
 * @swagger
 ...
 *                   example: null
 */
routerauth.get("/list-info-login",Limiter30, authMiddleware, getListLogin);
/**
 * @swagger
 * /list-info-login:
 *   get:
 *     summary: Mendapatkan riwayat aktivitas login pengguna
 *     description: Endpoint ini digunakan untuk mengambil daftar aktivitas login berdasarkan UUID pengguna yang sedang login. Hanya bisa diakses setelah autentikasi JWT (melalui `authMiddleware`).
 *     tags:
 *       - auth member
 *     security:
 *       - bearerAuth: []
...
routerauth.get("/count-user",authadmin, countUser);
